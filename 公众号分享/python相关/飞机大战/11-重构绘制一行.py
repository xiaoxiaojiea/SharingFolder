...
class game_functions():
    ...
    # 创建一个外星人并将其放在当前行
    def create_alien(self,mySettings, screen, aliens, alien_number):
        # 创建一个外星人
    ...
    # 创建外星人群组
    def create_fleet(self, mySettings, screen, aliens):
        alien = Alien(mySettings, screen)
        number_aliens_x = self.get_number_aliens_x(mySettings, alien.rect.width)

        # 一行可以放 number_aliens_x 个飞机。
        for alien_number in range(number_aliens_x):
            self.create_alien(mySettings, screen, aliens, alien_number)
...
def run_game():
    ...
    aliens = Group()
    # 创建外星人群
    game_function.create_fleet(mySettings, screen, aliens)
